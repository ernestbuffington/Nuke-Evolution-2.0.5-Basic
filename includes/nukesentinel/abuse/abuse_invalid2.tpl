...
<p align="center"><img src="includes/nukesentinel/abuse/logo.png" width="468" height="60" alt="" /> <br /><strong>You have attempted to access this site with an invalid User Agent.</strong></p>
...
<strong>Forwarded For:</strong> __FORWARDEDFOR__</p></td></tr></table>
</body>
</html>