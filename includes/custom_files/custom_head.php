...
-=[Block]=-
      JAG Whos Been                          v1.0.76      06/29/2005
 ************************************************************************/
...
/*****[BEGIN]******************************************
 [ Block:   JAG Whos Been                    v.1.0.76 ]
 ******************************************************/
/*=====
  Remove the // before the following 2 lines
  =====*/
//define_once('JAG_WHO', true);
//include_once(NUKE_INCLUDE_DIR.'custom_files/custom_head_JAG_Whos_Been.php');
/*****[END]********************************************
 [ Block:   JAG Whos Been                    v.1.0.76 ]
 ******************************************************/
