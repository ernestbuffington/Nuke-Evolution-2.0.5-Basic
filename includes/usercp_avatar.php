 ...
 ******************************************************/
function display_avatar_gallery($mode, &$category, &$user_id, &$email, &$current_email, &$coppa, &$username, &$email, &$new_password, &$cur_password, &$password_confirm, &$icq, &$myspace, &$aim, &$msn, &$yim, &$website, &$location, &$user_flag, &$occupation, &$interests, &$glance_show, &$signature, &$viewemail, &$notifypm, &$allow_mass_pm, &$popup_pm, &$notifyreply, &$attachsig, &$allowhtml, &$allowbbcode, &$allowsmilies, &$showavatars, &$showsignatures, &$hideonline, &$style, &$wrap, &$language, &$bday_month, &$bday_day, &$bday_year, &$timezone, &$time_mode, &$dst_time_lag, &$dateformat, &$show_quickreply, &$quickreply_mode, &$user_open_quickreply, &$session_id, $xdata = false, &$rname, &$extra_info, &$newsletter, &$hide_images, &$gender)
/*****[END]********************************************
 [ Mod:     Hide Images                        v1.0.0 ]
 [ Mod:     At a Glance Options                v1.0.0 ]
 [ Mod:     XData                              v1.0.3 ]
 ...
 ******************************************************/
{
        global $board_config, $db, $template, $lang, $images, $theme, $phpbb_root_path, $phpEx;
...
/*****[BEGIN]******************************************
 ...
 [ Mod:     Hide Images                        v1.0.0 ]
 ******************************************************/
        $params = array('coppa', 'user_id', 'username', 'email', 'current_email', 'cur_password', 'new_password', 'password_confirm', 'icq', 'myspace', 'aim', 'msn', 'yim', 'website', 'location', 'user_flag', 'occupation', 'interests', 'glance_show', 'signature', 'viewemail', 'notifypm', 'allow_mass_pm', 'popup_pm', 'notifyreply', 'attachsig', 'allowhtml', 'allowbbcode', 'allowsmilies', 'showavatars', 'showsignatures', 'hideonline', 'style', 'wrap', 'language', 'bday_month', 'bday_day', 'bday_year', 'timezone', 'time_mode', 'dst_time_lag', 'dateformat', 'show_quickreply', 'quickreply_mode', 'rname', 'extra_info', 'newsletter', 'hide_imagse', 'user_open_quickreply', 'gender');
/*****[END]********************************************
 [ Mod:     Hide Images                        v1.0.0 ]
 [ Mod:     At a Glance Options                v1.0.0 ]
 [ Mod:     YA Merge                           v1.0.0 ]
