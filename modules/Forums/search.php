...
else if ( $search_keywords != '' || $search_author != '' || $search_id )
{
    ...
    //
    if ( $search_id == 'newposts' || $search_id == 'newtopics' || $search_id == 'egosearch' || $search_id == 'unanswered' || $search_keywords != '' || $search_author != '' )
    {
 		//
 		// Flood control
 		//
        ...
        if ( $search_id == 'newposts' || $search_id == 'newtopics' || $search_id == 'egosearch' || ( $search_author != '' && $search_keywords == '' )  )
        {
