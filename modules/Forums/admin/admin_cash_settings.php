...
if ( !empty($setmodules) )
{
	...
	$phpbb['Cash Mod']['Cash_Settings'] = "$file";
	return;
}
...
if ( isset($HTTP_POST_VARS['submit']) )
{
	$message = $lang['Cash_settings_updated'] . "<br /><br />" . sprintf($lang['Click_return_cash_settings'], "<a href=\"" . append_sid("admin_cash_settings.$phpEx") . "\">", "</a>") . "<br /><br />" . sprintf($lang['Click_return_admin_index'], "<a href=\"" . append_sid("index.$phpEx?pane=right") . "\">", "</a>");
