...
die(mysql_error());
                      ...
                      $additional_tables = (isset($HTTP_POST_VARS['additional_tables'])) ? $HTTP_POST_VARS['additional_tables'] : ( (isset($HTTP_GET_VARS['additional_tables'])) ? $HTTP_GET_VARS['additional_tables'] : "" );
                        ...
                        //
                        echo "#\n";
                        echo "# Nuke-Evolution Database Backup\n";
                        ...
                        while($tables = mysql_fetch_row($result_tables))
                ...
                case 'restore':
                        ...
                        else
                        {
                                ...
                                if(empty($backup_file_tmpname) || empty($backup_file_name))
                                {
