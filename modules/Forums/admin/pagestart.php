 ...
 ******************************************************/
include_once('../../../includes/functions_jr_admin.php');
find_lang_file_nivisec('lang_jr_admin');

$jr_admin_userdata = jr_admin_get_user_info($cookie[0]);
/*****[END]********************************************
 [ Mod:    Junior Admin                        v2.0.5 ]
 ******************************************************/
 ...
 ******************************************************/
       //(is_user() && ($cookie[2] == $user_info['user_password']) && !empty($user_info['user_password']) && ($user_info['user_level'] == ADMIN))
        ((is_user($user2)) && ($cookie[2] == $user_info['user_password']) && !empty($user_info['user_password']) && (!empty($jr_admin_userdata['user_jr_admin']) || $user_info['user_level'] == ADMIN))
))
{
/*****[END]********************************************
 [ Mod:    Junior Admin                        v2.0.5 ]
...
/*****[BEGIN]******************************************
 [ Mod:    Junior Admin                        v2.0.5 ]
 ******************************************************/
if (!jr_admin_secure(basename($HTTP_SERVER_VARS['REQUEST_URI'])))
{
	message_die(GENERAL_ERROR, $lang['Error_Module_ID'], '');
}
/*****[END]********************************************
 [ Mod:    Junior Admin                        v2.0.5 ]
 ******************************************************/
