...
<form method="post" action="{S_FORUM_ACTION}"><table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
    ...
    <!-- BEGIN catrow -->
    <tr>
        <td class="catLeft" colspan="3"><span class="cattitle"><strong><a href="{catrow.U_VIEWCAT}">{catrow.CAT_DESC}</a></strong></span></td>
    ...
    <!-- BEGIN forumrow -->
    <tr> 
        <td class="row2"{catrow.forumrow.STYLE}><span class="gen">{catrow.forumrow.FORUM_ICON_IMG}&nbsp;&nbsp;<a href="{catrow.forumrow.U_VIEWFORUM}" target="_new">{catrow.forumrow.FORUM_NAME}</a></span><br /><span class="gensmall">{catrow.forumrow.FORUM_DESC}</span></td>
