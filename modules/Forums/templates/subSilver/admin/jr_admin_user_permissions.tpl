...
<br><table  border="0" cellpadding="3" cellspacing="1" class="forumline" align="center" width="95%">
	...
	<tr>
	<td class="catBottom" align="right">&nbsp;</td><td class="catBottom" align="center" width="10%">
		
		<input type="checkbox" name="check_all_page" onClick="toggle_check_all(check_all_page, 1);"></td>
		<td class="catBottom" align="left"><span class="gen">&nbsp;&nbsp;<-- {L_CHECK_ALL}&nbsp;&nbsp;</span></td>
	</tr>
<!-- BEGIN catrow -->
<tr>
	<td class="catSides" colspan="1"><span class="cattitle">{catrow.CAT}</span></td>
