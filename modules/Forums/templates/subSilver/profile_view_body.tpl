...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  ...
  <tr> 
    ...
    <tr> 
		  ...
		  <td width="100%"><strong><span class="gen">{PROFILE_VIEWS}</span></strong></td>
		</tr>
        <tr> 
        ...
        <!-- BEGIN cashrow --> 
<tr> 
<td valign="middle" align="right" nowrap="nowrap"><span class="gen">CASH:{cashrow.CASH_NAME}</span></td> 
<td><span class="gen">{cashrow.CASH_AMOUNT}</span></td> 
</tr> 
<!-- END cashrow --> 
...
<!-- END show_groups -->        
  ...
  <tr> 
    <td class="row1" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
        ...
        <td class="row1" valign="middle"><strong><span class="gen">{MYSPACE_IMG}</span></strong></td>
       </tr>
        <tr> 
