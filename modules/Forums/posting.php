...
$topic_type = ( in_array($topic_type, array(POST_NORMAL, POST_STICKY, POST_ANNOUNCE, POST_GLOBAL_ANNOUNCE, POST_ADD_TYPE)) || ($topic_type > 20) ) ? $topic_type : POST_NORMAL;
/*****[END]********************************************
 [ Mod:     Advanced Topic Types               v1.0.1 ]
 ******************************************************/
 ...
 ******************************************************/
  ...
  {
    if( ( ( $userdata['user_level'] >= $add_type['topic_type_auth'] && $add_type['topic_type_auth'] != ADMIN ) || $userdata['user_level'] == ADMIN ) && ( $add_type['topic_type_name'] != 'announce' && $add_type['topic_type_name'] != 'sticky' && $add_type['topic_type_name'] != 'global' ) )
    {
