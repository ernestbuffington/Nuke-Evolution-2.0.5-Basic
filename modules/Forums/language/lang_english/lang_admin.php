...
$lang['glance_news_explain'] = 'Enter the Forum ID of your News Forum<br /><small>Set to 0 if you dont have a news forum or dont want news displayed. Seperate News Forums with , (1,2,3).</small>';
$lang['glance_num_news_explain'] = 'Enter the number of news articles to display.<br /><small>Set to 0 if you dont have a news forum or dont want news displayed.</small>';
$lang['glance_num_explain'] = 'Enter the amount of recent topics to display';
$lang['glance_ignore_forums_explain'] = 'Enter the Forum ID of Forums you would like to be ignored on the recent topics list.<br /><small>Seperate Forums with , (1,2,3). Leave blank to show all.</small>';
