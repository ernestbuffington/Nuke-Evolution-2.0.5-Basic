...
$faq[] = array("Használhatok saját tageket?", "A jelenlegi 2.0-ás fórum nem teszi lehetõvé a saját tagek használatát.");
$faq[] = array('Mi is ez a PHP kód beszúrás!?', 'A PHP BBkód hasonlít Kód BBkódhoz, de ezt kifejezetten a PHP kódhoz használd.  Miért?  Mert a különbözõ PHP kódokat más-más szinekkel jeleníti meg, megkönnyítve annak olvasását.');
