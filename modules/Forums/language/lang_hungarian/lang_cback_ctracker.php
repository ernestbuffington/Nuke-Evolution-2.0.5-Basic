...
$lang['ctracker_set_catname5']			  = 'Register Protection System';
...
$lang['ctracker_settings_e13']			  = 'Activates or deactivates the Login IP System. Each user has the option to activate or deactivate the System in the Profile. The IP Protection System checks changes of the IP addresses. The user will be informed if the IP Range has been modified since his/her last Login. Here you\'ll see if someome has logged on from a different location.';
...
$lang['ctracker_info_pw_expired']		  = 'The administrator has made adjustments so that a password may be valid only for <b>%s days</b>. days. We recommend for safety reasons that you change your password now. (Profile)';
...
$lang['ctracker_lhistory_off']  = 'Login History was deactivatetd by Admin.';
...
$lang['ctracker_sendmail_info'] = 'Due to safety reasons you are only allowed to send an e-mail every % minutes.';
$lang['ctracker_pwreset_info']	= 'Due to safety reasons it is not possible to send a new password every % minutes. Please contact the administrator if you have trouble!';
