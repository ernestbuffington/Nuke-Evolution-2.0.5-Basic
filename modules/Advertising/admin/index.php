...
if(is_mod_admin($module_name)) {
    ...
    $ad_admin_menu_main = "<center><span class=\"title\"><strong>" . _BANNERSADMIN . "</strong></span><br /><br />[ <a href=\"".$admin_file.".php?op=ad_positions\">"._ADPOSITIONS."</a> - $cli - <a href=\"".$admin_file.".php?op=add_client\">"._ADDCLIENT."</a> - <a href=\"".$admin_file.".php?op=ad_terms\">"._TERMS."</a> - <a href=\"".$admin_file.".php?op=ad_plans\">"._PLANSPRICES."</a> ]</center>$act";
    ...
    function BannersAdmin() {
        ...
        while (list($bid, $cid, $name, $imptotal, $impmade, $clicks, $imageurl, $date, $type, $active, $ad_class) = $db->sql_fetchrow($result)) {
            ...
            echo "<td bgcolor=\"$bgcolor1\" align=center>".$name."</td>"
                ."<td bgcolor=\"$bgcolor1\" align=center><a href=\"".$admin_file.".php?op=BannerClientEdit&amp;cid=".$cid."\">$client_name</a></td>"
    ...
    function BannerEdit($bid) {
        ...
        if ($ad_class == "code") {
            $ad_code = Fix_Quotes(stripslashes($ad_code));
            echo "<table border=\"0\" align=\"center\"><tr><td>$ad_code</td></tr></table><br /><br />";
        } elseif ($ad_class == "flash") {
            echo "<center>
                <OBJECT classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\"
