...
<!-- BEGIN email --><a href="javascript:phpbbmail('{EMAIL2}.{EMAIL3}','{EMAIL1}')">{EMAIL1} [at] {EMAIL2} [dot] {EMAIL3}</a><!-- END email -->
...
<!-- BEGIN video -->
<div align="center"><embed allowScriptAccess="never" type="application/x-mplayer2" pluginspage="http://www.microsoft.com/Windows/MediaPlayer/" src="{URL}" showstatusbar="1" autostart="1" width="{WIDTH}" height="{HEIGHT}"></embed></div>
<!-- END video -->
