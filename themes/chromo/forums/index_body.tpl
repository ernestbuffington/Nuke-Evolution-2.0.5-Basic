...
<input type="hidden" name="op" value="login">
  ...
  <tr> 
	<td class="row1" width="100%" colspan="2"><span class="gensmall">{WELCOME_SUGGESTED_TOPICS}&nbsp;&nbsp;<a href="{WELCOME_SUGGESTED_LINK}" class"gensmall"><strong>{WELCOME_SUGGESTED_TITLE}</strong></a></span></td>
  </tr>
...
<td class="row1" width="100%" height="50" onmouseover="this.style.backgroundColor='#CCCCCC'" onmouseout="this.style.backgroundColor='#e0e0e0'"  onclick="window.location.href='{catrow.forumrow.U_VIEWFORUM}'"><span class="forumlink"> <a href="{catrow.forumrow.U_VIEWFORUM}" class="forumlink">{catrow.forumrow.FORUM_NAME}</a><br />
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
    <td class="row1" align="center" valign="middle" rowspan="3"><img src="themes/chromo/forums/images/whosonline.gif" alt="{L_WHO_IS_ONLINE}" /></td>
    <td class="row1" align="left" width="100%"><span class="gensmall">{TOTAL_POSTS}<br />{TOTAL_USERS}<br />{NEWEST_USER}<br />{BANS}<br /></span>
    </td>
  </tr>
  <tr> 
    ...
    {colors.GROUPS}
    <!-- END colors -->
    <br />{RECORD_USERS}<br />{LOGGED_IN_USER_LIST}<br />{USERS_OF_THE_DAY_LIST}</span></td>
    </tr>
      <!-- BEGIN birthdays -->
  <tr> 
  ...
  <tr> 
	<td class="row1" align="center" valign="middle"><img src="modules/Forums/templates/subSilver/images/icon_birthday.gif" alt="{L_VIEW_BIRTHDAYS}" /></td>
...
<table cellspacing="3" border="0" align="center" cellpadding="0">
  <tr> 
    <td width="20" align="center"><img src="themes/chromo/forums/images/folder_new.gif" alt="{L_NEW_POSTS}"/></td>
    <td><span class="gensmall">{L_NEW_POSTS}</span></td>
    <td>&nbsp;&nbsp;</td>
    <td width="20" align="center"><img src="themes/chromo/forums/images/folder.gif" alt="{L_NO_NEW_POSTS}" /></td>
    <td><span class="gensmall">{L_NO_NEW_POSTS}</span></td>
    <td>&nbsp;&nbsp;</td>
    <td width="20" align="center"><img src="themes/chromo/forums/images/folder_lock.gif" alt="{L_FORUM_LOCKED}" /></td>
