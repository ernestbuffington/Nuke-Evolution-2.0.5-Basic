...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0">
    ...
    <tr> 
        ...
        <br /><br />{postrow.POSTER_GENDER}<br />{postrow.POSTER_JOINED}<br />{postrow.POSTER_POSTS}<br />{postrow.POSTER_FROM}<br />{postrow.POSTER_FROM_FLAG}<br />{postrow.CASH}<br />{postrow.REPUTATION}<br />{postrow.POSTER_ONLINE_STATUS}<!-- -->
        <!-- BEGIN xdata -->
    ...
    <tr> 
        ...
        <td class="{postrow.ROW_CLASS}" width="100%" height="28" valign="bottom" nowrap="nowrap"><table cellspacing="0" cellpadding="0" border="0" width="18">
            <tr> 
                <td valign="middle" nowrap="nowrap">{postrow.PROFILE_IMG} {postrow.PM_IMG} {postrow.EMAIL_IMG} {postrow.WWW_IMG} {postrow.MYSPACE_IMG} {postrow.AIM_IMG} {postrow.YIM_IMG} {postrow.MSN_IMG}<script language="JavaScript" type="text/javascript"><!-- 
