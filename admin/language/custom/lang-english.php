 ...
 ******************************************************/
define("_ADMIN_VER_TITLE","Nuke-Evolution Version Checker");
define("_ADMIN_VER_ERRCON","Could not connect to www.nuke-evolution.com");
define("_ADMIN_VER_ERRSQL","Could not retrieve version from Database");
define("_ADMIN_VER_CHG","There is a new version of Nuke-Evolution");
...
define("_VER_ERR_CON","Could not connect to <a href='http://www.nuke-evolution.com'>Nuke-Evolution</a>");
...
define("_VER_CHGLOG","Nuke-Evolution Version Changed Log");
define('_VERSIONUP2DATE', 'Your installation is up to date, no updates are available for your version of Nuke Evolution.');
define('_VERSIONOUTOFDATE', 'Your installation does <strong>not</strong> seem to be up to date. Updates are available for your version of Nuke Evolution, please visit <a href="http://www.nuke-evolution.com/modules.php?name=Downloads" target="_new">http://www.nuke-evolution.com/modules.php?name=Downloads</a> to obtain the latest version.');
define('_VERSIONLATESTINFO', 'The latest available version is <strong>Nuke Evolution %s</strong>.');
define('_VERSIONCURRENTINFO', 'You are running <strong>Nuke Evolution %s</strong>.');
define('_VERSIONSOCKETERROR', 'Unable to open connection to Nuke Evolution Server, reported error is:<br />%s');
...
define("_THEMES_NOT_COMPAT", "<font color='red'>Your theme is not compatible with Advanced Features</font><br /><a href='http://evo-themez.com' target='_blank'>Evo-Themez</a>");
