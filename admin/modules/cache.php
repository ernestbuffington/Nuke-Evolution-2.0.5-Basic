...
function cache_header() {
    ...
    OpenTable();
        echo "<center>"
        ."<a href=\"$admin_file.php?op=cache\">" . _CACHE_HEADER . "</a>"
        ."<br /><br />"
        ...
        ."</table>"
        .'<br />'
        ."[ <a href=\"$admin_file.php?op=cache_clear\">" . _CACHE_CLEAR . "</a> | <a href=\"$admin_file.php\">" . _CACHE_RETURN . "</a> ]"
        ."</center>";
    CloseTable();
    echo "<br />";
}
...
function display_main() {
   ...
   $open = "<img src=\"images/evo/folder_open.gif\" alt=\"\" border=\"0\" name=\"folder\">";
   $closed = "<img src=\"images/evo/folder_closed.gif\" alt=\"\" border=\"0\" name=\"folder\">";

   echo "<script type=\"text/javascript\">
        <!--

        var folder_closed = new Image();
        folder_closed.src = \"images/evo/folder_closed.gif\";
        var folder_open = new Image();
        folder_open.src = \"images/evo/folder_open.gif\";
    ...
    if(is_array($cat_names)) {
        foreach($cat_names as $file) {
            ...
            ."<td width='40%' align='left' colspan=\"1\" class=\"row1\"><a id=\"$file\" href=\"javascript:show('$file', '$num_files');\">&nbsp;<img name='folder-$file' src='images/evo/folder_$img.gif' alt='' border='0'></a> <strong>" . $file . " ($num_files)</strong></td>\n"
