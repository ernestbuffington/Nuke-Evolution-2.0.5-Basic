...
if (isset($_GET['mods'])) {
    ...
    $info_cache = ereg_replace('(<th colspan="2">)', '<td class="row1" colspan="2">', $info_cache);
    $info_cache = ereg_replace('(<div class="center">|<\/div>)', '', $info_cache);
    $info_cache = ereg_replace('(<h2>)', '<fieldset><legend><strong>', $info_cache);
    $info_cache = ereg_replace('(<\/h2>)', '</strong><br />', $info_cache);
