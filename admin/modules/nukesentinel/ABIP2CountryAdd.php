...
echo "<tr bgcolor='$bgcolor1'><td align='center' class='content' colspan='2'>"._AB_ADDIP2COUNTRYS."</td></tr>\n";
...
echo "<tr><td colspan='2' align='center'><input type='hidden' name='op' value='ABIP2CountryAddSave' /><input type=submit value='"._AB_ADDIP2COUNTRY."' /></td></tr>\n";
echo "</table>\n";
echo "</form>";
CloseTable();
