...
if($totalselected > 0) {
  ...
  if($column == "ip_long") $column = 3;
  if($column == "c2c") $column = 3;
  if($column == "date") $selcolumn3 = "selected";
  echo "<option value='date' $selcolumn3>"._AB_DATE."</option>\n";
  if($column == "user_agent") $selcolumn4 = "selected";
  echo "<option value='user_agent' $selcolumn4>"._AB_USERAGENT."</option>\n";
  if($column == 3) $selcolumn5 = "selected";
  echo "<option value=3 $selcolumn5>"._AB_HITS."</option>\n";
  echo "</select> ";
