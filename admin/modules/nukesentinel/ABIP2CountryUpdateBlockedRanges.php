...
if(!isset($min)) {
  ...
  title($pagetitle);
  OpenTable();
  echo "<META HTTP-EQUIV=\"refresh\" content=\"$pagedelay;URL=".$admin_file.".php?op=ABIP2CountryUpdateBlockedRanges&min=$max\">";
  ...
  echo "<br />\n";
  OpenTable();
  echo "<center><strong>"._AB_IP2CUPDATEBLOCKEDRANGES." "._AB_COMPLETED."</strong><br /></center>\n";
  CloseTable();
  include(NUKE_BASE_DIR."footer.php");
}
