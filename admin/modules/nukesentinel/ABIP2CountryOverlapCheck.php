...
if(!isset($min)) {
  ...
  while(list($xip_lo, $xip_hi) = $db->sql_fetchrow($result)) {
    ...
    if($testnum1 > 0) {
      ...
      $testmessage .= "<td width='15%'><strong>"._AB_IPLO."</strong></td>\n";
      $testmessage .= "<td width='15%'><strong>"._AB_IPHI."</strong></td>\n";
      $testmessage .= "<td align='center' width='10%'><strong>"._AB_FLAG."</strong></td>\n";
      $testmessage .= "<td align='center' width='10%'><strong>"._AB_CODE."</strong></td>\n";
      $testmessage .= "<td align='center' width='35%'><strong>"._AB_COUNTRY."</strong></td>\n";
      $testmessage .= "<td align='center' width='15%'><strong>"._AB_FUNCTIONS."</strong></td>\n";
      $testmessage .= "</tr>\n";
      while($testrow1 = $db->sql_fetchrow($test1)) {
        ...
        $testmessage .= "<td align='center'>".$testrow1['country']."</td>\n";
        $testmessage .= "<td align='center'>&nbsp;<a href='".$admin_file.".php?op=ABIP2CountryEdit&amp;ip_lo=".$testrow1['ip_lo']."&amp;ip_hi=".$testrow1['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16' /></a>&nbsp;<a ";
        $testmessage .= "href='".$admin_file.".php?op=ABIP2CountryDelete&amp;ip_lo=".$testrow1['ip_lo']."&amp;ip_hi=".$testrow1['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16' /></a>&nbsp;</td>\n";
        $testmessage .= "</tr>\n";
      }
      $testmessage .= "</table>\n";
      $testmessage .= "<br />\n";
    ...
    if($testnum2 > 0) {
      ...
      while($testrow2 = $db->sql_fetchrow($test2)) {
        ...
        $testmessage .= "<td align='center'>".$testrow2['country']."</td>\n";
        $testmessage .= "<td align='center'>&nbsp;<a href='".$admin_file.".php?op=ABIP2CountryEdit&amp;ip_lo=".$testrow2['ip_lo']."&amp;ip_hi=".$testrow2['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16' /></a>&nbsp;<a ";
        $testmessage .= "href='".$admin_file.".php?op=ABIP2CountryDelete&amp;ip_lo=".$testrow2['ip_lo']."&amp;ip_hi=".$testrow2['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16' /></a>&nbsp;</td>\n";
        $testmessage .= "</tr>\n";
      }
      $testmessage .= "</table>\n";
      $testmessage .= "<br />\n";
    ...
    if($testnum3 > 0) {
      ...
      while($testrow3 = $db->sql_fetchrow($test3)) {
        ...
        $testmessage .= "<td align='center'>".$testrow3['country']."</td>\n";
        $testmessage .= "<td align='center'>&nbsp;<a href='".$admin_file.".php?op=ABIP2CountryEdit&amp;ip_lo=".$testrow3['ip_lo']."&amp;ip_hi=".$testrow3['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16' /></a>&nbsp;<a ";
        $testmessage .= "href='".$admin_file.".php?op=ABIP2CountryDelete&amp;ip_lo=".$testrow3['ip_lo']."&amp;ip_hi=".$testrow3['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16' /></a>&nbsp;</td>\n";
        $testmessage .= "</tr>\n";
      }
      $testmessage .= "</table>\n";
      $testmessage .= "<br />\n";
    ...
    if($testnum4 > 0) {
      ...
      while($testrow4 = $db->sql_fetchrow($test4)) {
        ...
        $testmessage .= "<td align='center'>".$testrow4['country']."</td>\n";
        $testmessage .= "<td align='center'>&nbsp;<a href='".$admin_file.".php?op=ABIP2CountryEdit&amp;ip_lo=".$testrow4['ip_lo']."&amp;ip_hi=".$testrow4['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16' /></a>&nbsp;<a ";
        $testmessage .= "href='".$admin_file.".php?op=ABIP2CountryDelete&amp;ip_lo=".$testrow4['ip_lo']."&amp;ip_hi=".$testrow4['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16' /></a>&nbsp;</td>\n";
        $testmessage .= "</tr>\n";
      }
      $testmessage .= "</table>\n";
      $testmessage .= "<br />\n";
  ...
  if($testmessage != "") {
    ...
    echo "<tr>\n";
    echo "<td>\n";
    echo "<form action='".$admin_file.".php?op=ABIP2CountryOverlapCheck' method='post'>\n";
    echo "<input type='hidden' name='min' value='$min' />\n";
    ...
    echo "<META HTTP-EQUIV=\"refresh\" content=\"$pagedelay;URL=".$admin_file.".php?op=ABIP2CountryOverlapCheck&min=$max\">";
    echo "<strong>"._AB_SECTION." $currentpage "._AB_OF." $pages (".$pdone."%) "._AB_COMPLETED."</strong><br />\n";
    echo "<strong>No conflicts were found in this section</strong><br />\n";
    if($currentpage < $pages) {
  ...
  echo "<br />\n";
  OpenTable();
  echo "<center><strong>"._AB_IP2COVERLAPCHECK." "._AB_COMPLETED."</strong><br />\n";
  CloseTable();
  include(NUKE_BASE_DIR."footer.php");
}
