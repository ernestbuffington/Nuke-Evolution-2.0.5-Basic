...
if(!isset($min)) {
  ...
  title($pagetitle);
  OpenTable();
  echo "<META HTTP-EQUIV=\"refresh\" content=\"$pagedelay;URL=".$admin_file.".php?op=ABIP2CountryUpdateTracked&min=$max\">";
  ...
  echo "<br />\n";
  OpenTable();
  echo "<center><strong>"._AB_IP2CUPDATETRACKED." "._AB_COMPLETED."</strong></center><br />\n";
  CloseTable();
  include(NUKE_BASE_DIR."footer.php");
}
