...
if($totalselected > 0) {
  ...
  // Page Sorting
  echo "<tr>\n";
  echo "<td align='right' bgcolor='$bgcolor2' colspan='7'><form method='post' action='".$admin_file.".php?op=ABExcludedList'><strong>"._AB_SORT.":</strong> ";
  ...
  while($getIPs = $db->sql_fetchrow($result)) {
    ...
    echo "<td align='center'$valign>&nbsp;<a href='".$admin_file.".php?op=ABPrintExcludedView&amp;ip_lo=".$getIPs['ip_lo']."&amp;ip_hi=".$getIPs['ip_hi']."' target='_blank'><img src='images/nukesentinel/print.png' border='0' alt='"._AB_PRINT."' title='"._AB_PRINT."' height='16' width='16' /></a>&nbsp;<a ";
    echo "href='".$admin_file.".php?op=ABExcludedView&amp;ip_lo=".$getIPs['ip_lo']."&amp;ip_hi=".$getIPs['ip_hi']."' target='_blank'><img src='images/nukesentinel/view.png' border='0' alt='"._AB_VIEW."' title='"._AB_VIEW."' height='16' width='16' /></a>&nbsp;<a ";
    echo "href='".$admin_file.".php?op=ABExcludedEdit&amp;ip_lo=".$getIPs['ip_lo']."&amp;ip_hi=".$getIPs['ip_hi']."&amp;min=$min&amp;column=$column&amp;direction=$direction&amp;xop=$op'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16' /></a>&nbsp;<a ";
    echo "href='".$admin_file.".php?op=ABExcludedDelete&amp;ip_lo=".$getIPs['ip_lo']."&amp;ip_hi=".$getIPs['ip_hi']."&amp;min=$min&amp;column=$column&amp;direction=$direction&amp;xop=$op'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16' /></a>&nbsp;</td>\n";
    echo "</tr>\n";
  }
  // Page Numbering
  ...
  if($pages != 1 && $pages != 0) {
    ...
    echo "<td width='33%'>";
    echo "<form action='".$admin_file.".php?op=ABExcludedList' method='post'>\n";
