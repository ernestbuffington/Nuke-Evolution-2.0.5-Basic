...
echo "</select></td></tr>\n";
echo "<tr><td bgcolor='$bgcolor2' valign='top'>".help_img(_AB_HELP_022)." "._AB_STRINGLISTADD.":</td>\n";
...
echo "<form action='".$admin_file.".php' method='post'>";
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>";
echo "<tr><td align='center' bgcolor='$bgcolor2' colspan='2'><strong>"._AB_STRINGLISTDELETE."</strong>\n";
echo "<input type='hidden' name='xblocker_row[block_name]' value='string' />\n";
echo "<input type='hidden' name='xblocker_row[list]' value='".$blocker_row['list']."' /></td></tr>\n";
$stringlist = explode("\r\n", $blocker_row['list']);
echo "<tr><td bgcolor='$bgcolor2'>".help_img(_AB_HELP_074)." "._AB_STRINGLIST.":</td>\n";
echo "<td><select name='xblocker_row[listdelete]'>\n";
for($i = 0; $i < count($stringlist); $i++) {
  echo "<option value=\"".addslashes($stringlist[$i])."\">".addslashes($stringlist[$i])."</option>\n";
}
echo "</select></td>\n</tr>\n";
echo "<tr><td align='center' colspan='2'><input type='hidden' name='xop' value='$op' />\n";
