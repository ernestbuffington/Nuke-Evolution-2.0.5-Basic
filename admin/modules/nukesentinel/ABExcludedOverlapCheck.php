...
if(!isset($min)) {
  ...
  while(list($xip_lo, $xip_hi) = $db->sql_fetchrow($result)) {
    ...
    if($testnum1 > 0) {
      ...
      while($testrow1 = $db->sql_fetchrow($test1)) {
        ...
        $testmessage .= "<td align='center'>&nbsp;<a href='".$admin_file.".php?op=ABExcludedEdit&amp;ip_lo=".$testrow1['ip_lo']."&amp;ip_hi=".$testrow1['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16'></a>&nbsp;<a ";
        $testmessage .= "href='".$admin_file.".php?op=ABExcludedDelete&amp;ip_lo=".$testrow1['ip_lo']."&amp;ip_hi=".$testrow1['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16'></a>&nbsp;</td>\n";
        $testmessage .= "</tr>\n";
      }
      $testmessage .= "</table>\n";
      $testmessage .= "<br />\n";
    ...
    if($testnum2 > 0) {
      ...
      while($testrow2 = $db->sql_fetchrow($test2)) {
        ...
        $testmessage .= "<td align='center'>&nbsp;<a href='".$admin_file.".php?op=ABExcludedEdit&amp;ip_lo=".$testrow2['ip_lo']."&amp;ip_hi=".$testrow2['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16'></a>&nbsp;<a ";
        $testmessage .= "href='".$admin_file.".php?op=ABExcludedDelete&amp;ip_lo=".$testrow2['ip_lo']."&amp;ip_hi=".$testrow2['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16'></a>&nbsp;</td>\n";
        $testmessage .= "</tr>\n";
      }
      $testmessage .= "</table>\n";
      $testmessage .= "<br />\n";
    ...
    if($testnum3 > 0) {
      ...
      while($testrow3 = $db->sql_fetchrow($test3)) {
        ...
        $testmessage .= "<td align='center'>&nbsp;<a href='".$admin_file.".php?op=ABExcludedEdit&amp;ip_lo=".$testrow3['ip_lo']."&amp;ip_hi=".$testrow3['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16'></a>&nbsp;<a ";
        $testmessage .= "href='".$admin_file.".php?op=ABExcludedDelete&amp;ip_lo=".$testrow3['ip_lo']."&amp;ip_hi=".$testrow3['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16'></a>&nbsp;</td>\n";
        $testmessage .= "</tr>\n";
      }
      $testmessage .= "</table>\n";
      $testmessage .= "<br />\n";
    ...
    if($testnum4 > 0) {
      ...
      while($testrow4 = $db->sql_fetchrow($test4)) {
        ...
        $testmessage .= "<td align='center'>&nbsp;<a href='".$admin_file.".php?op=ABExcludedEdit&amp;ip_lo=".$testrow4['ip_lo']."&amp;ip_hi=".$testrow4['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16'></a>&nbsp;<a ";
        $testmessage .= "href='".$admin_file.".php?op=ABExcludedDelete&amp;ip_lo=".$testrow4['ip_lo']."&amp;ip_hi=".$testrow4['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16'></a>&nbsp;</td>\n";
        $testmessage .= "</tr>\n";
      }
      $testmessage .= "</table>\n";
      $testmessage .= "<br />\n";
  ...
  if($testmessage != "") {
    ...
    echo "<META HTTP-EQUIV=\"refresh\" content=\"$pagedelay;URL=".$admin_file.".php?op=ABExcludedOverlapCheck&amp;min=$max\">";
    ...
    if($currentpage < $pages) {
      echo "<strong>"._AB_SECTION." ".($currentpage+1)." "._AB_OF." $pages (".$pdone."%) "._AB_WILLSTART."</strong><br />\n";
    }
  }
  CloseTable();
  include(NUKE_BASE_DIR."footer.php");
  ...
  echo "<br />\n";
  OpenTable();
  echo "<center><strong>"._AB_EXCLUDEDOVERLAPCHECK." "._AB_COMPLETED."</strong></center><br />\n";
  CloseTable();
  include(NUKE_BASE_DIR."footer.php");
}
