...
if($testnum1 > 0 OR $testnum2 >0 OR $testnum3 >0 OR $testnum4 >0) {
  ...
  if($testnum1 > 0) {
    ...
    while($testrow1 = $db->sql_fetchrow($test1)) {
      ...
      echo "<td align='center'>&nbsp;<a href='".$admin_file.".php?op=ABBlockedRangeEdit&amp;ip_lo=".$testrow1['ip_lo']."&amp;ip_hi=".$testrow1['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16'></a>&nbsp;<a ";
      echo "href='".$admin_file.".php?op=ABBlockedRangeDelete&amp;ip_lo=".$testrow1['ip_lo']."&amp;ip_hi=".$testrow1['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16'></a>&nbsp;</td>\n";
      echo "</tr>\n";
    }
    echo "</table>\n";
    echo "<br />\n";
  ...
  if($testnum2 > 0) {
    ...
    while($testrow2 = $db->sql_fetchrow($test2)) {
      ...
      echo "<td align='center'>&nbsp;<a href='".$admin_file.".php?op=ABBlockedRangeEdit&amp;ip_lo=".$testrow2['ip_lo']."&amp;ip_hi=".$testrow2['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16'></a>&nbsp;<a ";
      echo "href='".$admin_file.".php?op=ABBlockedRangeDelete&amp;ip_lo=".$testrow2['ip_lo']."&amp;ip_hi=".$testrow2['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16'></a>&nbsp;</td>\n";
      echo "</tr>\n";
    }
    echo "</table>\n";
    echo "<br />\n";
  ...
  if($testnum3 > 0) {
    ...
    while($testrow3 = $db->sql_fetchrow($test3)) {
      ...
      echo "<td align='center'>&nbsp;<a href='".$admin_file.".php?op=ABBlockedRangeEdit&amp;ip_lo=".$testrow3['ip_lo']."&amp;ip_hi=".$testrow3['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16'></a>&nbsp;<a ";
      echo "href='".$admin_file.".php?op=ABBlockedRangeDelete&amp;ip_lo=".$testrow3['ip_lo']."&amp;ip_hi=".$testrow3['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16'></a>&nbsp;</td>\n";
      echo "</tr>\n";
    }
    echo "</table>\n";
    echo "<br />\n";
  ...
  if($testnum4 > 0) {
    ...
    while($testrow4 = $db->sql_fetchrow($test4)) {
      ...
      echo "<td align='center'>&nbsp;<a href='".$admin_file.".php?op=ABBlockedRangeEdit&amp;ip_lo=".$testrow4['ip_lo']."&amp;ip_hi=".$testrow4['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/edit.png' border='0' alt='"._AB_EDIT."' title='"._AB_EDIT."' height='16' width='16'></a>&nbsp;<a ";
      echo "href='".$admin_file.".php?op=ABBlockedRangeDelete&amp;ip_lo=".$testrow4['ip_lo']."&amp;ip_hi=".$testrow4['ip_hi']."&amp;xop=ABMain' target='_blank'><img src='images/nukesentinel/delete.png' border='0' alt='"._AB_DELETE."' title='"._AB_DELETE."' height='16' width='16'></a>&nbsp;</td>\n";
      echo "</tr>\n";
    }
    echo "</table>\n";
    echo "<br />\n";
