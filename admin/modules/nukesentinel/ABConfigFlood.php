...
echo "<tr><td align='center' bgcolor='$bgcolor2' colspan='2'><strong>"._AB_FLOODBLOCKER."</strong>\n";
echo "<input type='hidden' name='xblocker_row[block_name]' value='flood' />\n";
echo "<input type='hidden' name='xop' value='$op' />\n";
echo "<input type='hidden' name='op' value='ABConfigSave' /></td></tr>\n";
...
if(!empty($ab_config['ftaccess_path']) AND is_writable($ab_config['ftaccess_path'])) {
  ...
  echo "<strong>"._AB_FTACCESSFAILED."</strong>";
}
...
if(stristr($_SERVER['SERVER_SOFTWARE'], "Apache") AND $ab_config['htaccess_path'] > "") {
  ...
  echo "<strong>"._AB_HTACCESSFAILED."</strong><input type='hidden' name='xblocker_row[ftaccess]' value='0' />";
}
echo "</td>\n</tr>\n";
