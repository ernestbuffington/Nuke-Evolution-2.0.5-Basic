...
echo "<tr bgcolor='$bgcolor1'><td align='center' class='content' colspan='2'>"._AB_ADDPROTECTEDS."</td></tr>\n";
...
echo "<tr><td bgcolor='$bgcolor2' valign='top'><strong>"._AB_NOTES.":</strong></td><td><textarea name='xnotes' rows='10' cols='40'>"._AB_ADDBY." $aid</textarea></td></tr>\n";
...
echo "<tr><td colspan='2' align='center'><input type='hidden' name='op' value='ABProtectedAddSave' /><input type='submit' value='"._AB_ADDPROTECTED."' /></td></tr>\n";
echo "</table></form>\n";
CloseTable();
