...
echo "</select></td></tr>\n";
echo "<tr><td bgcolor='$bgcolor2' valign='top'>".help_img(_AB_HELP_020)." "._AB_REFERERLISTADD.":</td>\n";
...
echo "<form action='".$admin_file.".php' method='post'>";
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>";
echo "<tr><td align='center' bgcolor='$bgcolor2' colspan='2'><strong>"._AB_REFERERLISTDELETE."</strong>\n";
echo "<input type='hidden' name='xblocker_row[block_name]' value='referer' />\n";
echo "<input type='hidden' name='xblocker_row[list]' value='".$blocker_row['list']."' /></td></tr>\n";
$refererlist = explode("\r\n", $blocker_row['list']);
echo "<tr><td bgcolor='$bgcolor2'>".help_img(_AB_HELP_074)." "._AB_REFERERLIST.":</td>\n";
