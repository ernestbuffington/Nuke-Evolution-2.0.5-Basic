...
elseif ($step == 2) {
    ...
    echo "<form method=post>"
        ."<table id=menu border=\"1\" width=\"100%\">"
        ."<th id=rowHeading align=\"center\" colspan=2>".$nuke_name." " . $install_lang['installer_heading'] . " $step " . $install_lang['installer_heading2'] . " ".$total_steps."</th>";
    echo "<tr><td align=\"center\">" . $install_lang['install_nsnsn'] . "</td></tr>";
    echo "<tr><td align=center colspan=2><input type=hidden name=step value=\"$next_step\"><input type=submit name=submit value=\"" . $install_lang['install'] . "\">  <input type=submit name=skip value=\"" . $install_lang['skip_install'] . "\"></td></tr>";
    echo "</table></form>";
    ...
    if (!empty($submit)) {
        ...
        echo "<form method=post>"
            ."<table id=menu border=\"1\" width=\"100%\">"
            ."<th id=rowHeading align=\"center\" colspan=2>".$nuke_name." " . $install_lang['installer_heading'] . " $step " . $install_lang['installer_heading2'] . " ".$total_steps."</th>";
        do_sql("upgrade/nukesentinel.sql");
        echo "<tr><td align=\"center\"><font color=\"green\">" . $install_lang['installed_nsnsn'] . "</font></td></tr>";
        echo "<tr><td align=\"center\">$continue_button</td></tr>"
            ."</table></form>";
        include('upgrade/footer.php');
    } else {
        ...
        echo "<form method=post>"
            ."<table id=menu border=\"1\" width=\"100%\">"
            ."<th id=rowHeading align=\"center\">".$nuke_name." " . $install_lang['installer_heading'] . " $step " . $install_lang['installer_heading2'] . " ".$total_steps."</th>";
        echo "<tr><td align=\"center\"><font color=\"green\">" . $install_lang['remember_nsnsn'] . "</font></td></tr>";
        echo "<tr><td align=\"center\">$continue_button</td></tr>"
            ."</table></form>";
