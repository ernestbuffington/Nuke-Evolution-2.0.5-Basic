...
|                                                         |
| There are two different cache options:                  |
|   1: SQL Cache                                          |
|	  - Will cache data into SQL tables, proves to be     |
|	    faster, but uses more queries.                    |
|   2: File Cache                                         |
|	  - Less queries, but more server usage               |
|                                                         |
| If you have problems with file permissions we recommend |
| that you use the SQL cache.                             |
|                                                         |
| Default: 1                                              |
---------------------------------------------------------*/
$use_cache = 1;
...
# allow persistent database connections (true = on, false = off)
$persistency = false;
