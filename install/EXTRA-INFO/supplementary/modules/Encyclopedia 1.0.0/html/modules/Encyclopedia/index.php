...
function list_content($eid) {
    ...
    title("$title");
    OpenTable();
    echo "<center><strong>$title</strong></center><br />"
    ...
    echo "<br />";
    OpenTable();
    echo "<center><span class=\"tiny\">"._COPYRIGHT." &copy; "._BY." $sitename</span></center>";
    CloseTable();
...
function content($tid, $ltr, $page=0, $query="") {
    ...
    echo "<span class=\"title\">$etitle</span><br /><br /><br />";
    ...
    $query = htmlentities($query);
        $contentpages[$arrayelement] = eregi_replace($query,"<strong>$query</strong>",$contentpages[$arrayelement]);
    ...
    if ($page == $pageno) {
        echo "<p align=\"right\">"._COPYRIGHT." &copy; "._BY." $sitename - ($ecounter "._READS.")</span></p>";
    }
    } else {
...
function list_themes() {
    ...
    OpenTable();
    echo "<center><span class=\"content\">"._AVAILABLEENCYLIST." $sitename:</center><br /><br />";
    ...
    echo "<br /><br /><center><strong>"._YOURADMININACTIVELIST."</strong></center><br /><br />";
    echo "<blockquote>";
