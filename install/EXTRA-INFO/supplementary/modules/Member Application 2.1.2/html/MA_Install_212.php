...
fflush ($handle);
fclose($handle);
echo "<center><H2>Update Complete<BR></H><H4>If you have any problems with the operation of this new version, post in the support forum at www.drivenbyfaith.org and paste in the contents of the file modules/Member_Application/admin/update.log.  It will help us greatly in determining the cause of any errors or malfunctions.</h></center>";
}  
  ...
  switch ($error)
  {
    case '0':
      $msg = "Congratulations!  Everything appears to have completed successfully in the install. "
            ...
            . "please visit our support forums at <a href=\"http://www.drivenbyfaith.org\">DBF Designs</a>";
    ...
    case '2':
      $msg .= "The install did not complete successfully.  There was an error in adding the Member Application tables to the database."
  	    ...
  	    . "Should you need support, or have any questions, please visit our support forums at <a href=\"http://www.drivenbyfaith.org\">DBF Designs</a>";
...
switch ($op)
{
  default:
    ...
    echo "  <tr>";
    echo "    <td align=\"center\" width=\"100%\">";
    echo "      <form METHOD=POST action='MA_Install_212.php'>";
    echo "      <SELECT NAME=\"op\">";
    echo "      <OPTION VALUE=\"new_install\">Clean Install of Member Application V 2.1.2</option>";
...
include(NUKE_MODULES_DIR . $module_name . "/copyright.php"); 
echo "    </td>";
echo "  </tr>";
echo "</table>";
