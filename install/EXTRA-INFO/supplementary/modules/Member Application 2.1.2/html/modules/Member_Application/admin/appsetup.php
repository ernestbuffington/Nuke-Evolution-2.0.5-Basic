...
echo "<H4>".MA_FORMTITLE."</H4> ";
echo "    <INPUT NAME=\"formtitle\"  VALUE=\"".$row1['formtitle']."\" SIZE=\"70\" >";
echo "    </td>";
echo "  </tr>";
echo "  <tr>";
echo "    <td valign=\"top\">";
...
echo "    <tr>";
echo "    <TD>";
echo "      <br><H4>".MA_APPLICATIONTEXT."</H4>";
echo "      <i>".MA_APPTXTHINT."</i><br>";
echo "    </TD>";
echo "  </tr>";
echo "  <TR>";
echo "    <TD align=\"left\">";
echo "      <TEXTAREA NAME=\"edcfg\" COLS=80 ROWS=10>".$row1['apptxt']."</TEXTAREA>";
...
echo "      <INPUT NAME=\"admad\" ID=\"admad\" VALUE=\"".$row1['admaddr']."\" SIZE=\"20\" style=\"display:none\">";
echo "    </td>";
echo "  </tr>";
echo "  <TR valign=\"top\">";
echo "    <TD>";
...
if( !($grresult = $db->sql_query($grsql)) )
{
  echo " <br>ERROR - 8A3 - ".MA_UATOGTERR."!";
  exit();
}
while ($grouplist = $db->sql_fetchrow($grresult))
{
...
echo "  <tr valign=\"top\">";
echo "  <td >";
echo "  <B>".MA_EDCOMPAT."</B>";
echo "  </td>";
echo "  <td align=\"left\">";
if ($row1['compat'])
{
  echo "  <INPUT TYPE=CHECKBOX ID=\"ecompat\" NAME=\"ecompat\" CHECKED>";
}
else
{
  echo "  <INPUT TYPE=CHECKBOX ID=\"ecompat\" NAME=\"ecompat\">";
}
echo "  </td>";
echo "  </tr>";
...
echo "  <TR>";
echo "    <TD align=\"left\">";
echo "      <TEXTAREA NAME=\"edtytxt\" COLS=80 ROWS=10>".$row1['tytxt']."</TEXTAREA>";
echo "    </TD>";
echo "  <TR>";
echo "    <TD>";
...
echo "  <TR>";
echo "    <TD align=\"left\">";
echo "      <TEXTAREA NAME=\"noapptxt\" COLS=80 ROWS=10>".$row1['noapptxt']."</TEXTAREA><br>";
echo "    </TD>";
echo "  </TR>";
...
echo "      <INPUT TYPE=SUBMIT VALUE=\"".MA_SAVECHANGES."\">";
echo "    </td>";
echo "  </tr>";
echo "</table>";
echo "</form>";
