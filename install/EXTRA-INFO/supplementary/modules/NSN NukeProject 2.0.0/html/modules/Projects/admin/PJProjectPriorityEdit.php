...
$pagetitle = ": "._PJ_TITLE." ".$pj_config['version_number'].": "._PJ_PROJECTS.": "._PJ_EDITPRIORITY;
...
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._PJ_UPDATEPROJECTPRIORITY."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
pj_copy();
