...
$pagetitle = ": "._PJ_TITLE." ".$pj_config['version_number'].": "._PJ_PROJECTS.": "._PJ_PROJECTADD;
...
echo "<td><select name='featured'><option value='0' selected>"._PJ_NO."</option>\n";
echo "<option value='1'>"._PJ_YES."</option></select></td></tr>\n";
echo "<tr><td bgcolor='$bgcolor2'>"._PJ_ACTIVATEREPORTS.":</td>\n";
echo "<td><select name='allowreports'><option value='0' selected>"._PJ_NO."</option>\n";
echo "<option value='1'>"._PJ_YES."</option></select></td></tr>\n";
...
echo "</select></td></tr>\n";
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._PJ_PROJECTADD."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
pj_copy();
