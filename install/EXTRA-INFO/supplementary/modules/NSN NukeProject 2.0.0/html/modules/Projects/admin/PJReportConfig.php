...
echo "<option value='0'$notify_b>"._PJ_NO."</option></select></td></tr>\n";
echo "<tr><td bgcolor='$bgcolor2'><strong>"._PJ_NEWREPORTSTATUS.":</strong></td>\n";
...
echo "</select></td></tr>\n";
echo "<tr><td bgcolor='$bgcolor2'><strong>"._PJ_NEWREPORTTYPE.":</strong></td>\n";
...
echo "<tr><td bgcolor='$bgcolor2'><strong>"._PJ_NEWREPORTPOSITION.":</strong></td>\n";
