...
$pagetitle = ": "._PJ_TITLE." ".$pj_config['version_number'].": "._PJ_REPORTS.": "._PJ_REPORTEDIT;
...
echo "</select></td></tr>\n";
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._PJ_REPORTUPDATE."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
echo "<br />\n";
...
echo "<tr><td align='left' bgcolor='$bgcolor2' width='100%' colspan='2'><strong>"._PJ_REPORTMEMBERS."</strong></td>";
