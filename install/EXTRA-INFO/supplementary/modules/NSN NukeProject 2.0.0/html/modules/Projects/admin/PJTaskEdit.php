...
$pagetitle = ": "._PJ_TITLE." ".$pj_config['version_number'].": "._PJ_TASKS.": "._PJ_EDITTASK;
...
echo "</select></td></tr>\n";
echo "<tr><td align='center' colspan='2'><input type='submit' value='"._PJ_UPDATETASK."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
echo "<br />";
...
echo "<input type='hidden' name='task_id' VALUE='$task_id'>";
echo "<tr><td align='left' bgcolor='$bgcolor2' width='100%' colspan='2'><strong>"._PJ_TASKMEMBERS."</strong></td>";
