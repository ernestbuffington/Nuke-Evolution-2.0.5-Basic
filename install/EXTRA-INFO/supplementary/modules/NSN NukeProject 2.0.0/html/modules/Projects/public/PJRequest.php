...
if($project['allowrequests'] > 0) {
  ...
  echo "<tr><td bgcolor='$bgcolor2' colspan='2' width='100%'><nobr><strong>"._PJ_REQUESTINFO."</strong></nobr></td>\n";
  ...
  echo "<tr><td align='center'><img src='$pjimage'></td>\n";
  echo "<td colspan='3' width='100%'><nobr>"._PJ_REQUESTEDBY.": <strong><a href='mailto:".pjencode_email($request['submitter_email'])."'>".$request['submitter_name']."</a></strong></nobr></td></tr>\n";
  ...
  echo "<tr><td bgcolor='$bgcolor2' colspan='3' width='100%'><nobr><strong>"._PJ_REQUESTMEMBERS."</strong></nobr></td>";
  ...
  echo "<tr><td bgcolor='$bgcolor2' width='100%'><nobr><strong>"._PJ_COMMENTS."</strong> <strong>(</strong> <a href='modules.php?name=$module_name&amp;op=PJRequestCommentSubmit&amp;request_id=$request_id'>"._PJ_COMMENTADD."</a> <strong>)</strong></nobr></td><tr>\n";
  if($comment_total > 0){
