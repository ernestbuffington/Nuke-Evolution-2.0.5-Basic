...
echo "<tr><td colspan='4' width='100%'><nobr><strong>"._PJ_PROJECTNAME."</strong></nobr></td></tr>\n";
...
echo "<tr><td colspan='2' width='100%'><nobr><strong>"._PJ_REQUESTINFO."</strong></nobr></td>\n";
echo "<td align='center'><strong>"._PJ_STATUS."</strong></td>\n";
echo "<td align='center'><strong>"._PJ_TYPE."</strong></td></tr>\n";
...
echo "<tr><td align='center'><img src='$pjimage'></td>\n";
echo "<td colspan='3' width='100%'><nobr>"._PJ_REQUESTEDBY.": <strong>".$request['submitter_email']."</strong></nobr></td></tr>\n";
...
echo "<tr><td colspan='4' width='100%'><nobr><strong>"._PJ_REQUESTMEMBERS."</strong></nobr></td></tr>\n";
if($member_total != 0){
...
echo "<tr><td width='100%'><nobr><strong>"._PJ_COMMENTS."</strong></nobr></td><tr>\n";
if($comment_total > 0){
