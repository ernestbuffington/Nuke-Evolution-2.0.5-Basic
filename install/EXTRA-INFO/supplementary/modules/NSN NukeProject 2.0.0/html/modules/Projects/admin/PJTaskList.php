...
echo "<tr><td colspan='3' bgcolor='$bgcolor2'><nobr><strong>"._PJ_TASKOPTIONS."</strong></nobr></td></tr>\n";
...
echo "<tr><td><img src='$pjimage'></td><td colspan='2' width='100%'><nobr>"._PJ_TOTALTASKS.": <strong>$taskrows</strong></nobr></td></tr>\n";
echo "</table>\n";
//CloseTable();
echo "<br />\n";
...
//OpenTable();
echo "<table width='100%' border='1' cellspacing='0' cellpadding='2'>\n";
echo "<tr><td bgcolor='$bgcolor2' width='100%' colspan='2'><nobr><strong>"._PJ_TASKS."</strong></nobr></td>\n";
