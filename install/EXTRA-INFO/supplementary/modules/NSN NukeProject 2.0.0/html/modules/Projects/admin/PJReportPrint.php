...
echo "<tr><td colspan='2' width='100%'><nobr><strong>"._PJ_REPORTINFO."</strong></nobr></td>\n";
...
echo "<tr><td align='center'><img src='$pjimage'></td>\n";
echo "<td colspan='3' width='100%'><nobr>"._PJ_REPORTEDBY.": <strong>".$report['submitter_email']."</strong></nobr></td></tr>\n";
...
echo "<tr><td colspan='4' width='100%'><nobr><strong>"._PJ_REPORTMEMBERS."</strong></nobr></td></tr>\n";
if($member_total != 0){
