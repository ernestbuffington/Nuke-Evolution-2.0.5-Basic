...
if($project['allowreports'] > 0) {
  ...
  if((!$report_name) || (empty($report_name))) $stop = "<center>"._PJ_ERRORNOSUMMARY."</center><br />\n";
  if((!$report_description) || (empty($report_description))) $stop = "<center>"._PJ_ERRORNODESCRIPTION."</center><br />\n";
  if(empty($stop)) {
    ...
    OpenTable();
    echo "<center><strong>"._PJ_ERRORREPORT."</strong><br />\n";
    echo "$stop<br />\n";
