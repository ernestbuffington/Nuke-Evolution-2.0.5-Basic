...
$pagetitle = ": "._PJ_TITLE." ".$pj_config['version_number'].": "._PJ_TASKS.": "._PJ_EDITSTATUS;
...
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._PJ_UPDATETASKSTATUS."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
pj_copy();
