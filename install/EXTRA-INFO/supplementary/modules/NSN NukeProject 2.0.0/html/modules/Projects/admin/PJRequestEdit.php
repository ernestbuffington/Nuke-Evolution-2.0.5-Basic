...
$pagetitle = ": "._PJ_TITLE." ".$pj_config['version_number'].": "._PJ_REQUESTS.": "._PJ_REQUESTEDIT;
...
echo "</select></td></tr>";
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._PJ_REQUESTUPDATE."'></td></tr>";
echo "</form>";
echo "</table>";
CloseTable();
echo "<br />";
...
echo "<tr><td align='left' bgcolor='$bgcolor2' width='100%' colspan='2'><strong>"._PJ_REQUESTMEMBERS."</strong></td>";
echo "<td align='center' bgcolor='$bgcolor2'><strong>"._PJ_POSITION."</strong></td>";
echo "<td align='center' bgcolor='$bgcolor2'><strong>"._PJ_DELETE."</strong></td></tr>";
