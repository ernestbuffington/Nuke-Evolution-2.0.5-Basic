...
if($project['allowreports'] > 0) {
  ...
  if((!$commenter_name) || (empty($commenter_name))) $stop = "<center>"._PJ_ERRORNONAME."</center><br />\n";
  if((!$commenter_email) || (empty($commenter_email))) $stop = "<center>"._PJ_ERRORNOEMAIL."</center><br />\n";
  if((!eregi("^[_\.0-9a-z-]+@([0-9a-z][0-9a-z-]+\.)+[a-z]{2,6}$",$commenter_email))) $stop = "<center>"._PJ_ERRORINVALIDEMAIL."</center><br />\n";
  if((!$comment_description) || (empty($comment_description))) $stop = "<center>"._PJ_ERRORNOCOMMENT."</center><br />\n";
  if(empty($stop)) {
    $report_id = intval($report_id);
    ...
    OpenTable();
    echo "<center><strong>"._PJ_ERRORCOMMENT."</strong><br />\n";
    echo "$stop<br />\n";
