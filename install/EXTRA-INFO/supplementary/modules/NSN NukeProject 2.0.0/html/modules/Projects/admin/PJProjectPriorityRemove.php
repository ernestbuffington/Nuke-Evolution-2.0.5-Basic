...
$pagetitle = ": "._PJ_TITLE." ".$pj_config['version_number'].": "._PJ_PROJECTS.": "._PJ_DELETEPRIORITY;
$priority_id = intval($priority_id);
if($priority_id < 1) { header("Location: ".$admin_file.".php?op=PJProjectPriorityList"); }
...
echo "<tr><td align='center'><strong>"._PJ_SWAPPROJECTPRIORITY."</strong></td></tr>\n";
...
echo "</select></td></tr>\n";
echo "<tr><td align='center'><input type='submit' value='"._PJ_DELETEPRIORITY."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
pj_copy();
