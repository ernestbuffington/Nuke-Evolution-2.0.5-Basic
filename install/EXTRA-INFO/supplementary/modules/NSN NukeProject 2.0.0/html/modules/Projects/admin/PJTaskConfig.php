...
$pagetitle = ": "._PJ_TITLE." ".$pj_config['version_number'].": "._PJ_TASKS.": "._PJ_CONFIG;
...
echo "<tr><td bgcolor='$bgcolor2'><strong>"._PJ_NEWTASKSTATUS.":</strong></td>\n";
...
echo "</select></td></tr>\n";
echo "<tr><td bgcolor='$bgcolor2'><strong>"._PJ_NEWTASKPRIORITY.":</strong></td>\n";
...
echo "<tr><td bgcolor='$bgcolor2'><strong>"._PJ_NEWTASKPOSITION.":</strong></td>\n";
