...
// $Id: block-Calendar_centerlist.php,v 20.15 2004/08/29 02:00:06 EllselAn Exp $
...
$scrolling = 0;                                # Scroll entries edgeways: 0 = No / 1 = Yes
...
$eventwidth = 250;                             # Width of single Events while scrolling
$showTitle = 1;                                # Show block title: 0 = No / 1 = Yes
$scrolltopmargin = -2;                         # Scrolling spacing from top: Any integer value in px (pixel)
$showHeader = 1;                               # Show table header: 0 = No / 1 = Yes
$showLegend = 1;                               # Show color legend: 0 = No / 1 = Yes
$showNewlink = 1;                              # Show Link Event: 0 = No / 1 = Yes
$showalldot = 1;                               # Dots for all Events: 0 = No / 1 = Yes
$legendCols = 3;                               # Amount of columns in the category list. Leave it blank if you like to use the calendar settings
