...
<table width="90%" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr> 
    <td width="600" align="left" valign="middle" nowrap><span class="nav"><a href="../../../modules.php?name=Forums&file=index" class="nav">{L_INDEX}</a> 
...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="1" class="forumline">
  ...
  <tr> 
    <td width="150" align="left" valign="top" class="{ROW_CLASS}"><span class="name"><a name="{U_POST_ID}"></a><strong>{POSTER_NAME}</strong></span><br /> 
