                  ...
                  <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
                      ...
                      <tr> 
                        ...
                        <td class="row1"> <div align="left"> 
                            ...
                            <input type="button" name="usersearch" value="{L_APPROVE_BUTTON_FIND}" class="liteoption" onClick="window.open('./../../../modules.php?name=Forums&file=search&mode=searchuser&popup=1&menu=1', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" />
                          </div></td>
                      </tr>
                      <tr> 
