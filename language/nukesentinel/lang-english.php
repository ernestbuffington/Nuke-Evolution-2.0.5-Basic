...
define('_AB_CURVER','Your version is up to date!');
define('_AB_DATE','Date');
define('_AB_DATETIME','Date &amp; Time');
define('_AB_DBMAINTENCE','Database Maintenance');
...
define('_AB_FTACCESSFAILED','You can not use .ftaccess writing until you have set the .ftaccess path in <a href="'.$admin_file.'.php?op=ABMain">admin</a>.');
...
define('_AB_HARVESTERLISTDELETE','Harvest List Delete');
...
define('_AB_HELP_019',"Enter string to block, it will be added to the list.<br />Strings will be matched against the User Agent and can be partial or complete UA strings.");
define('_AB_HELP_020',"Enter domain string to block, it will be added to the list.<br />Strings will be matched against the HTTP Referer and should be in the format of <strong>domainname.tld</strong> or <strong>sub.domainname.tld</strong>.");
define('_AB_HELP_021',"Enter string block, it will be added to the list.<br />Here you may block any <strong>Request Method</strong> you want.<br /><br /><strong>WARNING!!!!!</strong> Entering GET or POST will put your site in an endless loop!");
define('_AB_HELP_022',"Enter string to block, it will be added to the list.<br />Here you may block any <strong>String</strong> you want.<br />Strings will be matched against the <strong>Query String</strong> so use caution when blocking strings.");
...
define('_AB_HELP_030',"Allows you to search either the <strong>Blocked IP Addresses</strong> or the <strong>Tracked IP Addresses</strong> for a specific IP address.");
...
define('_AB_HELP_058',"<strong>GOD ADMINS ONLY:</strong> Allows you to view, optimize, and repair your database. Shows all  NukeSentinel(tm) tables.");
define('_AB_HELP_059',"<strong>GOD ADMINS ONLY:</strong> Displays your NukeSentinel(tm) database including total space used and total overhead.");
...
define('_AB_HELP_074',"This option will <strong>REMOVE</strong> the selected item from the listing.");
...
define('_AB_HELP_114',"Allows you to directly import IP Ranges into the <strong>IP2Country</strong> or <strong>Blocked Ranges</strong> database tables.");
define('_AB_HELP_115',"Allows you to directly import IP Ranges into the <strong>Blocked Ranges</strong> database table.<br /><br /><strong>WARNING:</strong> This will prevent entire countries from visiting your site!");
define('_AB_HELP_116',"Allows you to directly import IP Ranges into the <strong>IP2Country</strong> database table.");
...
define('_AB_HTACCESSFAILED','You can not use .htaccess writing until you have set the .htaccess Path in <a href="'.$admin_file.'.php?op=ABMain">admin</a>.');
...
define('_AB_HTWRITEX','');
define('_AB_IMPORTBY','Imported by');
define('_AB_IMPORTDATA','Import Data');
define('_AB_IMPORTIP2C','Import to IP2Country');
define('_AB_IMPORTRANGE','Import to Blocked Ranges');
define('_AB_IN','in');
...
define('_AB_NEWVER','New version is available!');
...
define('_AB_SUBMENU','<br /><img src="images/nukesentinel/Sentinel_Small.png" height="31" width="88" alt="" title="" />');
define('_AB_SUBMITRANGETONSN','Submit to NukeScripts(tm)');
